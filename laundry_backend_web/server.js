...
role: data.role === 'pending_staff' || data.role === 'rejected_staff' ? 'staff' : data.role,
status: data.status || (data.role === 'pending_staff' ? 'pending' : (data.role === 'rejected_staff' ? 'rejected' : 'approved')),
...
role: localUser.role === 'pending_staff' || localUser.role === 'rejected_staff' ? 'staff' : localUser.role,
status: localUser.status || (localUser.role === 'pending_staff' ? 'pending' : (localUser.role === 'rejected_staff' ? 'rejected' : 'approved')),
