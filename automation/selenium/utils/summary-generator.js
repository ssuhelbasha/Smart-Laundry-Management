'use strict';
/**
 * GitHub Actions Summary Generator – Selenium Web
 */
const fs = require('fs');
...
function generateSummary() {
  ...
  const summaryContent = `## 🌐 Live GitHub Pages E2E Execution Summary

| Metric | Value |
|--------|-------|
| **Deployment URL** | [${summary.baseUrl}](${summary.baseUrl}) |
...
| **Pass Percentage** | ${summary.passRate}% | ${parseFloat(summary.passRate) >= 95 ? '✅ Above 95% Threshold' : '❌ Below 95%'} |
...
` : '### ✅ All Tests Passed!\n\nNo failures detected in this live run.\n'}
...
---
*Powered by Smart Laundry QA Web Automation Framework*
`;
